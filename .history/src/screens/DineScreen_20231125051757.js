    ...
    <div class="map-container grid platinum postContainer">
      <div class="m sidebar">
        ...
        <div class="listing-item" id="listing-store">
          ...
          <div id="series-posts-container" class="postStore">
          </div>
        </div>
        ...
        <div class="listing-item" id="listing-store">
          ...
          <div id="stores-container" class="postStore">
          </div>
        </div>
        ...
        <div class="listing-item" id="listing-store">
          ...
          <div id="reviewed-stores-container" class="postStore">
          </div>
        </div>
        ...
        <div class="listing-item" id="listing-store">
          ...
          <div id="second-closest-stores-container" class="postStore">
          </div>
        </div>
        ...
        <div class="listing-item" id="listing-store">
          ...
          <div id="latest-nearby-blogs-container" class="postStore">
          </div>
        </div>
        ...
        <div class="listing-item" id="listing-store">
          ...
          <div id="third-closest-stores-container" class="postStore">
          </div>
        </div>
  ...
  after_render: async () => {
    ...
    // console.log("categories: ", categories);
      ...
      map.on("moveend", function () {
        ...
        renderFeatures(sortedFeatures, map, 'some-container-id'); // Replace 'some-container-id' with the correct ID
    });
      map.on("click", (e) => {
        const bbox = [
