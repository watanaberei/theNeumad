...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        // NEARBY STORE
        const nearbyHeadline = store.nearbyStore.nearbyStoreCollection.headline || [];
        ...
        const nearbyLogoGallery = store.nearbyStore.media.logo && Array.isArray(store.nearbyStore.media.logo) && store.nearbyStore.media.logo.length ? store.nearbyStore.media.logo : [];
