  ...
  const StoreScreen = {
      render: async () => {
       ...
       // Store
        ...
        const nearbyLogoGallery = store.nearbyStoreCollection.logo.url && Array.isArray(store.nearbyStoreCollection.media.logo.url) && store.nearbynearbyStoreCollectionStore.media.logo.url.length ? store.nearbyStoreCollection.media.logo.url : [];
