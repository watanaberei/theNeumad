  ...
  after_render: async () => {
    ...
    // console.log("categories: ", categories);
      ...
      map.on("moveend", function () {
        ...
        // Assuming you have containers with IDs like 'store-container', 'blog-container', etc.
        renderFeatures(sortedFeatures.filter(f => f.properties.type === 'store'), map, 'store-container');
        renderFeatures(sortedFeatures.filter(f => f.properties.type === 'blog'), map, 'blog-container');
        // ... similarly for other feature types and their respective containers ...
    });
      map.on("click", (e) => {
        const bbox = [
