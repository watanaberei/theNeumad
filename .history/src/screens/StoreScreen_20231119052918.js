...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        //   ATTRIBUTES
        const categoryType = store.categoryTypes && store.categoryTypes.length ? store.categoryTypes : [];
        console.log("categoryType",categoryType);
        const limitedcategoryType06 = categoryType.slice(0, 6);
        console.log("limitedcategoryType04",limitedcategoryType06);
        let categoryTypesHTML = '';
        limitedcategoryType06.forEach(categoryTypes => {
            categoryTypesHTML += `
            <div class="store-categoryTypes-item">
                <div class="store-categoryTypes-icon">
                    <div class="store-categoryTypes-icons-container">
                        <span class="bold03">
                            <i class="store-attributes-icon icon-attributes-${categoryTypes.key}"></i>
                        </span>
                    </div>
                </div>
                <div class="store-categoryTypes-contemt">
        ...
        // console.log("categoryTypesHTML",categoryTypesHTML);
        //   ATTRIBUTES
