  ...
  const StoreScreen = {
      render: async () => {
       ...
       // Store
        ...
        const nearbyLogoGallery = store.nearbyStore.media.logo.url && Array.isArray(store.nearbyStore.media.logo.url) && store.nearbyStore.media.logo.url.length ? store.nearbyStore.media.logo.url : [];
