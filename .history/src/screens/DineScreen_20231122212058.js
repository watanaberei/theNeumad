...
if (!store) {
  console.log("Store object is undefined.");
  // Handle the case where store is not available
  return; // or show an error message to the user
}

const storeAttributes = store?.storeAttributes ?? [];
const storeAttributesHTML = generateStoreAttributesHTML(storeAttributes);
// Rest of the code
