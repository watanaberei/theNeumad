  ...
  const StoreScreen = {
      render: async () => {
       ...
       // Store
        ...
        const logoGallery =  nearbyLogo  && Array.isArray(nearbyLogo) && nearbyLogo.length ? nearbyLogo : [];
        console.log("logoGallery",logoGallery);
        const nearbyGalleryHTML = generateLogoCarouselHTML(logoGallery);
