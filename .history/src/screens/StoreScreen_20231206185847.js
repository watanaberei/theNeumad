  ...
  const StoreScreen = {
      render: async () => {
       ...
       // Store
        ...
        const nearbyLogoGallery = store.nearbyStore.logo.url && Array.isArray(store.nearbyStore.logo.url) && store.nearbyStore.logo.url.length ? store.nearbyStore.logo.url : [];
