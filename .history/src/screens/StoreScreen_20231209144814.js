...
function generateStorePopularTimeHTML(popularTimes) {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const storePopularTimes = require('./StorePopularTimes'); // Adjust path as necessary

        window.onload = function() {
            // Fetch or define your popularTimesData here
            const popularTimesData = /* your data fetching logic or static data */

            // Ensure chartsContainer div is available in the DOM
