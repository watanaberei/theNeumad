...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const popularTimeHTML = storePopularTimes(popularTime);
...
storePopularTimes(popularTimes);  // Ensure 'popularTimes' data is available here
                    ...
                    <section class="store-time"> 
                        ...
                        <div class="store-title">
                            <div class="store-body-title-container"> 
                                <span class="header04">
                                    LOCATION
                                    ${storeCurrentStatusHTMLs(popularTimes)}
                                </span>   
                            </div>   
                            ...
                            <!------ GRAPH ------>
                            ${popularTimeHTML}
                            ${storePopuplarTimes(popularTimes)}
                            <div class="chart-container" id="chartsContainer">
                                <!-- Dynamic content will be appended here -->
                                <!--storePopuplarTimes(popularTimes); // Example usage of storePopuplarTimes function-->
                            </div>
                            <!------ GRAPH ------>
...
// TODO: Call storePopularTimes here with the appropriate data once the DOM is fully loaded
}
// Error: Could not find the line with the "await" statement to fix