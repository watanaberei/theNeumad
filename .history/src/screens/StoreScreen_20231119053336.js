...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        //   ATTRIBUTES
        const storeAttribute = store.storeAttribute && store.storeAttribute.length ? store.storeAttribute : [];
