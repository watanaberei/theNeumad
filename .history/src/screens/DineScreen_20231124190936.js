...
const DineScreen = {
  ...
  after_render: async () => {
    ...
    geocoder.on('clear', () => {
        ...
        // Get user location and sort features
        const userLocation = await getUserLocation(); // Assuming this function is correctly implemented
        const sortedFeatures = sortFeaturesByDistance(features, userLocation);
    
        // Define the sorting and slicing logic for each category
