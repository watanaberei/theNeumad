...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const nearbyLogoGallery = store.nearbyStore.storesNearbyStoresCollection.logo && Array.isArray(store.nearbyStore.storesNearbyStoresCollection.logo) && store.nearbyStore.storesNearbyStoresCollection.logo.length ? store.nearbyStore.storesNearbyStoresCollection.logo : [];
        const nearbyLogoGalleryData =  nearbyLogoGallery  && Array.isArray(nearbyLogoGallery) && nearbyLogoGallery.length ? nearbyLogoGallery : [];
        const nearbyGalleryHTML = generateCarouselHTML(nearbyLogoGalleryData);
