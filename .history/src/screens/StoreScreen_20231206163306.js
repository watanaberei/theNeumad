...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const nearbyLogoGallery = store.nearbyStore.media.logo && Array.isArray(store.nearbyStore.media.logo) && store.nearbyStore.media.logo.length ? store.nearbyStoreCollection.logo : [];
