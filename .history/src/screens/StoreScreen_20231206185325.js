...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const nearbyLogoGallery = store.nearbyStore.logo.logo && Array.isArray(store.nearbyStore.media.logo) && store.nearbyStore.media.logo.length ? store.nearbyStore.media.logo : [];
