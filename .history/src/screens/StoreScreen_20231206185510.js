  ...
  const StoreScreen = {
      render: async () => {
       ...
       // Store
        ...
        const nearbyLogoGallery = store.nearbyStoreCollect.logo.logo && Array.isArray(store.nearbyStore.logo.logo) && store.nearbyStore.logo.logo.length ? store.nearbyStore.logo.logo : [];
