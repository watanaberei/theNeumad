...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const gallery = store.media.gallery && Array.isArray(store.media.gallery) && store.media.gallery.length ? store.media.gallery : [];
        ...
        const carouselGalleryHTML = generateCarouselHTML(galleryData);
        ...
        limitedSummaryFacility06.forEach(summaryFacility => {
            ...
            <div class="store-storeAttributes-item">
                <div class="store-storeAttributes-icon">
                    <div class="store-storeAttributes-icons-container">
                        <span class="bold03">
                            <i class="store-attributes-icon icon-attributes-${summaryFacility.key}"></i>
                        </span>
                    </div>
                </div>
                <div class="store-storeAttributes-contemt">
        ...
        limitedSummaryService06.forEach(summaryService => {
            ...
            <div class="store-storeAttributes-item">
                <div class="store-storeAttributes-icon">
                    <div class="store-storeAttributes-icons-container">
                        <span class="bold03">
                            <i class="store-attributes-icon icon-attributes-${summaryService.key}"></i>
                        </span>
                    </div>
                </div>
                <div class="store-storeAttributes-contemt">
      ...
      if (!store) {
        ...
        const recommendations = store.recommendations[0];
        const recommend = service.key || [];
        const recommendation = service.value || [];
...
function generateCarouselHTML(gallery) {
    let galleryHTML = '';
    gallery.slice(0, 3).forEach(galleryItem => {
      galleryHTML += `
                <img src="${galleryItem.url}" class="galleryItem" alt="" />
      `;
    });
    return galleryHTML;
}
