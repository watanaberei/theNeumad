...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const nearbyLogoGallery = store.nearbyStoreCollection.logo && Array.isArray(store.nearbyStoreCollection.logo) && store.nearbyStoreCollection.logo.length ? store.nearbyStoreCollection.logo : [];
