...
const renderOptions = {
  ...
  const StoreScreen = {
    ...
    //   console.log("recommendation",recommendation);
        ...
        const summaryOverview = store.summary && store.summary.overview && store.summary.overview.length ? store.summary.overview : [];
        console.log("summaryText",summaryText);
        const limitedsummaryText04 = summaryText.slice(0, 4);
        const limitedsummaryOverview04 = summaryOverview.slice(0, 4);
        ...
        let summaryOverviewHTML = '';
        limitedsummaryOverview04.forEach(summaryOverview => {
            summaryOverviewHTML += `
            <div class="store-summary-item">
                <div class="store-summary-icons">
                    <div class="store-summary-icons-container">
                        <span class="bold03">
                            <i class="section-tag-icon icon-${summaryOverview.key}-21"></i>
                        </span>
                    </div>
                </div>
                <div class="store-summary-contemt">
        ...
        console.log("summaryOverviewHTML",summaryOverviewHTML);
