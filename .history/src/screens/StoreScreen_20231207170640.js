...
import { initNearbyMap } from "../components/MapApi";
                ...
                <div class="body">
                    ...
                    <section class="store-service"> 
                        ...
                        <div class="store-title">
                            ...
                            <!------ MAP ------>
                            <div class="s map nearbyMap" id="map nearbyMap">
                                <div id="nearbyMap-container" class="nearbyMap-container fullBleed"></div>
                            </div>
                            <div class="store-body-media-carousel">
                                ${nearbyGalleryHTML}
                            </div>
