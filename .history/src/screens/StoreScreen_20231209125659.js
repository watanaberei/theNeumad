...
function generateStorePopularTimeHTML(popularTimes) {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const popularTimeHTML = storePopularTimes(popularTimes);
        console.log("popularTimeHTML",popularTimeHTML);
        const popularTimesHTML = getStoreCurrentStatusHTML(popularTimes);
        storePopularTimes(popularTimes);
        generateStorePopularTimeHTML(popularTimes);
        console.log("popularTimesHTML",popularTimesHTML);
        console.log("popularTimes",popularTimes);
        console.log("getStoreCurrentStatusHTML",getStoreCurrentStatusHTML(popularTime));
        console.log("generateStorePopularTimeHTML",generateStorePopularTimeHTML);
                ...
                <div class="body">
                    ...
                    <section class="store-time"> 
                        ...
                        <div class="store-title">
                            ...
                            <!------ GRAPH ------>
                            ${popularTimesHTML(popularTimes)}
                            <div class="chart-container" id="chartsContainer">
                                ${generateStorePopularTimeHTML}
                                ${popularTimesHTML}
                                ${getStoreCurrentStatusHTML(popularTimes)}
