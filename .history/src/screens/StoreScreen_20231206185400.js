...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const nearbyLogoGallery = store.nearbyStore.logo.logo && Array.isArray(store.nearbyStore.logo.logo) && store.nearbyStore.logo.logo.length ? store.nearbyStore.logo.logo : [];
