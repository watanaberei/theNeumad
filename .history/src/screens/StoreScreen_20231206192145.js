  ...
  const StoreScreen = {
      render: async () => {
        ...
        nearbyStores.forEach(nearbyStore => {
            ...
            const headline = nearbyStore.headline;
            const hours = nearbyStore.hours;
            const locationItems = nearbyStore.locationCollection.items;
            const logoUrl = nearbyStore.logo ? nearbyStore.logo.url : '';

            // Use these variables as needed in your code
            console.log(headline, hours, locationItems, logoUrl);
