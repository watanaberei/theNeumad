...
const renderOptions = {
  ...
  const StoreScreen = {
      render: async () => {
        ...
        const mediaGalleryyHTML = generateMediaGalleryHTML(galleryData);
        const carouselMediaGalleryHTML = generateCarouselHTML(galleryData);
        ...
        const galleryHTML = generateMediaGalleryHTML(galleryData);
                                ...
                                <div class="top store-hero-IMG">
                                    <div class="store-hero-container">
                                        ...
                                        <div class="store-hero-container-secondary">
                                            <img src="${store.media.mediaGallery[0].url}" alt="" />
                                            <img src="${store.media.mediaGallery[1].url}" alt="" />
                                        </div>
                                    </div>                   
                                </div>
                            </div>
