...
// Define the function outside of the if block for better readability and potential reuse
...
if (variant === 'stores') { 
  ...
  const storeContentData = {
      thumbnail: thumbnail,
      logo: logo,
      title: title,  // Make sure this is what you want here
      galleryHTML: galleryHTML,
      headline: headline,
      publishedAt: publishedAt,
      storeType: storeType,
      ...
      noiseLevel: noiseLevel,
      parking: parking, 
      text: text,  // Changed from 'title' to 'text' to avoid duplicate properties
      neustar: neustar,
      neustarHTML: neustarHTML,
      categoryType: categoryType,
      region: region,
      ...
      genre: genre,
      best: originalBest,
      storeCurrentStatus: storeStatusHTML
  };
