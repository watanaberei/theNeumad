...
export function createGeojsonListing(store, map, userCoordinates) {
    ...
    const { 
        lat, best, neustar, lon, seriesName,  address, tag, slug, variant, 
        ...
        case 'articles':
            ...
            <div class="articles">
                ...
                <div class="articles-container">
                    ${createArticleCard(logo, title, categoryType,   bestHTML, thumbnail)}
                </div>
            </div>`;
            break;
        case 'stores':
            ...
            <div class="stores">
                ...
                <div class="stores-container">
                    ${createStoreCard(logo, neustar, galleryHTML, title, genre, categoryType,   bestHTML)}
                </div>
            </div>`;
            break;
        case 'reviews':
            ...
            <div class="reviews">
                ...
                <div class="reviews-container">
                    ${createReviewCard(logo, thumbnail, title,   bestHTML)}
                </div>
            </div>`;
            break;
        case 'blogs':
            ...
            <div class="blogs">
                ...
                <div class="blogs-container">
                    ${createBlogCard(variant, slug, categoryType, logo, title, subtitle,   tagsHTML)}
                </div>
            </div>`;
            break;
        default:
            contentHTML = createDefaultCard(logo, title, subtitle,   tagsHTML);
    }
...
//     }
//     function generateCarouselItem(storeContent) {
//         const storeCarouselItem = document.createElement('div');
//         storeCarouselItem.className = 'card-postCarousel-item';
//         storeCarouselItem.innerHTML = 'Reviewed Cards' + storeContent;
//         return storeCarouselItem;
//     }

//     const carouselItem = generateCarouselItem(storeContent);
