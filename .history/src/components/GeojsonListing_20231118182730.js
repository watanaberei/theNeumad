        ...
        case 'articles':
            ...
            <div class="articles">
                ...
                <div class="articles-container">
                    ${createArticleCard.render(logo, title, categoryType, region, bestHTML, thumbnail)}
                </div>
            </div>`;
            break;
        case 'stores':
            ...
            <div class="stores">
                ...
                ${createStoreCard.render(logo, neustar, galleryHTML, title, genre, categoryType, region, bestHTML)}    
        ...
        case 'reviews':
            ...
            <div class="reviews">
                ...
                <div class="reviews-container">
                    ${createReviewCard.render(logo, thumbnail, title, region, bestHTML)}
                </div>
            </div>`;
            break;
        case 'blogs':
            ...
            <div class="blogs">
                ...
                <div class="blogs-container">
                    ${createBlogCard.render(variant, slug, categoryType, logo, title, subtitle, region, tagsHTML)}
                </div>
            </div>`;
            break;
        default:
            contentHTML = createDefaultCard.render(variant, title, region, tagsHTML);
    }
