...
const HeaderHome = {
  ...
  after_render: async (map) => {
    ...
    const searchContainer = document.getElementById('.nav-main-center.search-container');
    const searchInput = document.getElementById('.search input, .search input[type="text"]');
