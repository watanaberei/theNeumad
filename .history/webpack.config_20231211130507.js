...
module.exports = {
  ...
  plugins: [
   ...
   devtool: 'source-map', // Include source maps for debugging (use 'inline-source-map' for development)
  devServer: {
    static: {
      directory: path.join(__dirname, 'public'), // The static files to serve
    },
