    ...
    const newLocal=`<nav class="navigation container nav-top">
          ...
          <section class="nav-mid">
            ...
            <div class="nav-brand-logo">
              <!-- logo -->
              <a class="logo" href="#"> 
                <img src="./images/brand/twn_brand_logo-H-med_v02.svg" alt="" />
              </a>
            </div>
            ...
            <div class="nav-primary-container">
              ...
              <div class="nav-primary-menu"> 
                ...
                <ul class="nav-list nav-flex"> 
                  ...
                  <li>
                    <a href="/#/work">
                      <div class="section" id="Work">
                        <i class="section-icon icon-work"></i>
                        <span class="section-divider">
                          <div class="lineV"></div>
                        </span>
                        <span class="section-text medium01">
                            Work
                        </span>
                      </div>
                    </a>
                  ...
                  <li>
                    <a href="/#/dine">
                      <div class="section" id="Dine">
                        <i class="section-icon icon-unwind"></i>
                        <span class="section-divider">
                          <div class="lineV"></div>
                        </span>
                        <span class="section-text medium00">
                            Dine
                        </span>
                      </div>
                    </a>
                  ...
                  <a href="/#/shorts">
                    <div class="section" id="Shorts">
                        <i class="section-icon icon-shorts"></i>
                        <span class="section-divider">
                          <div class="lineV"></div>
                        </span>
                        <span class="section-text medium01">
