...
import { getBlogs, getFeaturedBlog } from "../api.js";
...
const HomeScreen = {
  render: async () => {
    ...
    console.log(featuredBlogs) // Debugging information
    console.log(blogs);

    // const featuredBlogHtml = FeaturedBlog.render(featuredData.featured);
