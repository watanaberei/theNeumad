// src/components/HeaderUnwind.js
const HeaderUnwind = {
    render: () => {
      const newLocal=`<nav class="navigation container navSecondary-top">
  
            <section class="navSecondary-reportBar">
              <div class="navSecondary-reportBar-container">
                <div class="navSecondary-reportBar-content">
                    ...
                    <div class="nav-utility-left">
                        ...
                        <div class="nav-hamburger">
                            <span class="nav-hamburger-container">
                                ...
                                <span class="display02">Unwind</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="nav-utility-right">
                        ...
                        <div class="navSecondary-utility-mid-logo">
                            ...
                            <a class="navSecondary-utility-mid-logo-container" href="/"> 
                                <img src="./images/brand/twn_brand_logo-H-med_v07.svg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
