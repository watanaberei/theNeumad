...
export function createGeojsonStoreListing(store, map, userCoordinates) {
  ...
  const { 
    lat, lon, popularTimes, best: originalBest, neustar, headline, title, 
    seriesName, region, address, tag: originalTag, 
    slug, variant, thumbnail, gallery: originalGallery, nearbyStore,
    logo, area, service, storeType,environment,
